...
public class ListaTitulosRelatorioConvenio extends BasePage<TituloFiliado> {
	...
	public ListaTitulosRelatorioConvenio(Instituicao convenio, Filiado filiado, LocalDate dataInicio, LocalDate dataFim, Municipio pracaProtesto, SituacaoTituloRelatorio tipoRelatorio) {
	...
	private JasperPrint novoRelatorioDeTitulosPorConvenio(Instituicao convenio,Filiado filiado, LocalDate dataInicio, 
		...
		JasperReport jasperReport = JasperCompileManager.compileReport(getClass().getResourceAsStream("../../relatorio/RelatorioTituloConvenio.jrxml"));
