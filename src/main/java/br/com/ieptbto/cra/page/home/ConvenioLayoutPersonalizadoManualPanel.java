 ...
 *
 */
public class ConvenioLayoutPersonalizadoManualPanel extends Panel {
	...
	public ConvenioLayoutPersonalizadoManualPanel(String id, Usuario usuario, UsuarioFiliado usuarioFiliado) {
		super(id);
	...
	private boolean definirVisibilidade() {
		...
		if (usuarioFiliado == null && layout == LayoutPadraoXML.ENTRADA_MANUAL_LAYOUT_PERSONALIZADO) {
			return true;
		}
		return false;
	}
