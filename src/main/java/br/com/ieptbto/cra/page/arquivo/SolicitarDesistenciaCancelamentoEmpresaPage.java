 ...
 *
 */
public class SolicitarDesistenciaCancelamentoEmpresaPage extends BasePage<TituloFiliado>{

	/***/
	private static final long serialVersionUID = 1L;
	private static final Logger logger = Logger.getLogger(SolicitarDesistenciaCancelamentoEmpresaPage.class);
	...
	public SolicitarDesistenciaCancelamentoEmpresaPage() {
	...
	private Form<TituloFiliado> formularioConsultaTitulo() {
		Form<TituloFiliado> form = new Form<TituloFiliado>("form", getModel()){
			...
			protected void onSubmit() {
				...
				Filiado filiado = usuarioFiliadoMediator.buscarEmpresaFiliadaDoUsuario(getUser());
				...
				try {
					...
					setResponsePage(new ListaTitulosDesistenciaCancelamentoPage(filiado, dataInicio, dataFim , pracaProtesto ,titulo));
