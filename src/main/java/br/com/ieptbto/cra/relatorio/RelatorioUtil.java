...
public class RelatorioUtil implements Serializable {
	...
	public JasperPrint gerarRelatorioTitulosPorSituacaoFiliado(SituacaoTituloRelatorio situacaoTitulosRelatorio, Filiado filiado, Municipio municipio, 
		...
		try {
			initParams();
			this.params.put("FILIADO_ID", getFiliado().getId());
